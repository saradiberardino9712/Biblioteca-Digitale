...
public class AssegnaPagineController {
    ...
    @FXML
    void initialize() {
        assert linkIndietro != null : "fx:id=\"linkIndietro\" was not injected: check your FXML file 'AssegnaPagine.fxml'.";
        assert btnConferma != null : "fx:id=\"btnConferma\" was not injected: check your FXML file 'AssegnaPagine.fxml'.";
