...
public class ConsentiPubblicazioneTrascrizionePageController {
    ...
    @FXML
    private ListView<?> listaTrascrizioni;

    @FXML
    private TextArea txtTestoTrascrizione;
    ...
    @FXML
    void ConsentirePubblicazione(ActionEvent event) {

    }

    @FXML
    void NonConsentirePubblicazione(ActionEvent event) {
    ...
    void initialize() {
        ...
        assert txtTestoTrascrizione != null : "fx:id=\"txtTestoTrascrizione\" was not injected: check your FXML file 'ConsentiPubblicazioneTrascrizionePage.fxml'.";
